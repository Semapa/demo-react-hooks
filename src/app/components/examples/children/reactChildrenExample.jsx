...
const FormComponent = ({ children }) => {
    ...
    /**
     * Children - это массив объектов, но если это один children, то просто объект
     * чтобы map не возвращал ошибку когда один объект, а не массив используем React.Children
     */
